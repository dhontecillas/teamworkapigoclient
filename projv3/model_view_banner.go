...
// ViewBanner Banner contains all the information returned from a form banner.
...
func (o ViewBanner) MarshalJSON() ([]byte, error) {
...
type NullableViewBanner struct {
	value *ViewBanner
	isSet bool
}

func (v NullableViewBanner) Get() *ViewBanner {
	return v.value
}

func (v *NullableViewBanner) Set(val *ViewBanner) {
	v.value = val
	v.isSet = true
}

func (v NullableViewBanner) IsSet() bool {
	return v.isSet
}

func (v *NullableViewBanner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewBanner(val *ViewBanner) *NullableViewBanner {
	return &NullableViewBanner{value: val, isSet: true}
}

func (v NullableViewBanner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewBanner) UnmarshalJSON(src []byte) error {
	v.isSet = true
