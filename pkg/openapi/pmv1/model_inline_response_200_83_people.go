...
// InlineResponse20083People struct for InlineResponse20083People
type InlineResponse20083People struct {
	...
	Permissions *InlineResponse20083Permissions `json:"permissions,omitempty"`
...
func NewInlineResponse20083People() *InlineResponse20083People {
	this := InlineResponse20083People{}
	return &this
}
...
func (o *InlineResponse20083People) GetPermissions() InlineResponse20083Permissions {
	if o == nil || o.Permissions == nil {
		var ret InlineResponse20083Permissions
		return ret
	}
...
// SetPermissions gets a reference to the given InlineResponse20083Permissions and assigns it to the Permissions field.
...
func (o InlineResponse20083People) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20083People struct {
	value *InlineResponse20083People
	isSet bool
}

func (v NullableInlineResponse20083People) Get() *InlineResponse20083People {
	return v.value
}

func (v *NullableInlineResponse20083People) Set(val *InlineResponse20083People) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20083People) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20083People) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20083People(val *InlineResponse20083People) *NullableInlineResponse20083People {
	return &NullableInlineResponse20083People{value: val, isSet: true}
}

func (v NullableInlineResponse20083People) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20083People) UnmarshalJSON(src []byte) error {
	v.isSet = true
