...
type InlineResponse20082 struct {
	...
	Posts *[]InlineResponse20082Posts `json:"posts,omitempty"`
}
...
func (o *InlineResponse20082) GetPosts() []InlineResponse20082Posts {
	if o == nil || o.Posts == nil {
		var ret []InlineResponse20082Posts
		return ret
	}
	return *o.Posts
}
...
// SetPosts gets a reference to the given []InlineResponse20082Posts and assigns it to the Posts field.
