...
type InlineResponse20028 struct {
	UserStatus *InlineResponse20028UserStatus `json:"userStatus,omitempty"`
}
...
func (o *InlineResponse20028) GetUserStatus() InlineResponse20028UserStatus {
	if o == nil || o.UserStatus == nil {
		var ret InlineResponse20028UserStatus
		return ret
	}
	return *o.UserStatus
}
...
// SetUserStatus gets a reference to the given InlineResponse20028UserStatus and assigns it to the UserStatus field.
