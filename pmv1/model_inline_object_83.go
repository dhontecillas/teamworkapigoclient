...
type InlineObject83 struct {
	Comment *ResourceResourceIdCommentsJsonComment `json:"comment,omitempty"`
}
...
func (o *InlineObject83) GetComment() ResourceResourceIdCommentsJsonComment {
	if o == nil || o.Comment == nil {
		var ret ResourceResourceIdCommentsJsonComment
		return ret
	}
	return *o.Comment
}
...
// SetComment gets a reference to the given ResourceResourceIdCommentsJsonComment and assigns it to the Comment field.
