...
type InlineResponse20017 struct {
	Expenses *[]InlineResponse20017Expenses `json:"expenses,omitempty"`
}
...
// SetExpenses gets a reference to the given []InlineResponse20017Expenses and assigns it to the Expenses field.
