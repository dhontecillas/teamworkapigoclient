...
// InlineResponse200108TodoItems struct for InlineResponse200108TodoItems
type InlineResponse200108TodoItems struct {
	...
	ParentTask *InlineResponse200108ParentTask `json:"parent-task,omitempty"`
...
func NewInlineResponse200108TodoItems() *InlineResponse200108TodoItems {
	this := InlineResponse200108TodoItems{}
	return &this
}
...
func (o *InlineResponse200108TodoItems) GetParentTask() InlineResponse200108ParentTask {
	if o == nil || o.ParentTask == nil {
		var ret InlineResponse200108ParentTask
		return ret
	}
	return *o.ParentTask
}
...
// SetParentTask gets a reference to the given InlineResponse200108ParentTask and assigns it to the ParentTask field.
...
func (o InlineResponse200108TodoItems) MarshalJSON() ([]byte, error) {
	...
	if o.ParentTask != nil {
		toSerialize["parent-task"] = o.ParentTask
	}
...
type NullableInlineResponse200108TodoItems struct {
	value *InlineResponse200108TodoItems
	isSet bool
}

func (v NullableInlineResponse200108TodoItems) Get() *InlineResponse200108TodoItems {
	return v.value
}

func (v *NullableInlineResponse200108TodoItems) Set(val *InlineResponse200108TodoItems) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200108TodoItems) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200108TodoItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200108TodoItems(val *InlineResponse200108TodoItems) *NullableInlineResponse200108TodoItems {
	return &NullableInlineResponse200108TodoItems{value: val, isSet: true}
}

func (v NullableInlineResponse200108TodoItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200108TodoItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
