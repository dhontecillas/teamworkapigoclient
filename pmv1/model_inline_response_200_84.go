...
type InlineResponse20084 struct {
	People *[]InlineResponse20084People `json:"people,omitempty"`
}
...
func (o *InlineResponse20084) GetPeople() []InlineResponse20084People {
	if o == nil || o.People == nil {
		var ret []InlineResponse20084People
		return ret
	}
	return *o.People
}
...
// SetPeople gets a reference to the given []InlineResponse20084People and assigns it to the People field.
