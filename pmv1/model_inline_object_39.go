...
type InlineObject39 struct {
	Person *PeopleIdJsonPerson `json:"person,omitempty"`
}
...
// SetPerson gets a reference to the given PeopleIdJsonPerson and assigns it to the Person field.
